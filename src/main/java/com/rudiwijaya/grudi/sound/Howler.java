...
import com.rudiwijaya.grudi.AutoDisableAjaxCallListener;
import com.rudiwijaya.grudi.GrowlBehavior;
import com.rudiwijaya.grudi.Interaction;
import com.rudiwijaya.grudi.sound.cleanus1.Cleanus1Sounds;
import com.rudiwijaya.grudi.sound.feather.FeatherSounds;
...
public class Howler {
	...
	public static final Set<Interaction> LOOPED_SOUNDS = ImmutableSet.of(Interaction.LOADING_HEAVY, Interaction.LOADING_LIGHT);
	...
	public static String play(Interaction interaction, Sounds sounds) {
		...
		if (sprite.isPresent()) {
			final boolean looped = LOOPED_SOUNDS.contains(interaction);
