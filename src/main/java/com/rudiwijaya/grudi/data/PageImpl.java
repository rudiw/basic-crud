...
public class PageImpl<T> implements Page<T>, Serializable {
	...
	public PageImpl(List<T> content, Pageable pageable, long total) {
		...
		if (isOverflowed()) {
			log.warn(
					"Page is hard capped at {}, returning only a subset of {} {}s ({} pages)",
					pageable.getPageSize(), total, content.iterator().next()
							.getClass().getSimpleName(), getTotalPages());
		}
	}
	...
	public boolean isOverflowed() {
		return !content.isEmpty() && pageable != null && pageable.isCapped()
